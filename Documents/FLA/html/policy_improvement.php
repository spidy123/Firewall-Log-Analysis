            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Firewall Policy Improvement</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                       
                        <ol class="breadcrumb">
                            <li><a href="#">Firewall Policy Improvement</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total None-Categorized Domains</h3>
                            <ul class="list-inline two-part">
                                <li>
                                    <div id="sparklinedash3"></div>
                                </li>
                                <li class="text-right"><i class="ti-arrow-up text-info">
<?php
include "connection.php";
$qur = "SELECT COUNT(*) as cnt from nonecat";
$res = mysql_query($qur);
$row = mysql_fetch_array($res);
$number_of_rows = $row['cnt'];
?>                                    

                                </i> <span class="counter text-info"><?php echo $number_of_rows?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title">Top None-Categorized Domains</h3>
                                <div id="topUnblockedDomains" style="width: 100%; height: 400px;"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">All None-Categorized Domains</h3>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>None-Categorized domain</th>
                                            <th>Total HITS</th>
                                        </tr>
                                    </thead>
                                    <tbody>
<?php
$qur = "SELECT domain,hits FROM nonecat ORDER BY hits DESC;";
$res = mysql_query($qur);
$row_cnt = 1;
...
?>
                                        <tr>
                                            ...
                                            <td class="txt-oflo"><?php echo $row['domain'];?></td>
                                            <td><span class="text-success"><?php echo $row['hits'];?></span></td>
                                        </tr>
<?php
$row_cnt++;
}
...
AmCharts.makeChart("topUnblockedDomains", {
  "type": "serial",
  "theme": "none",
  "dataLoader": {
    "url": "top_none_categories.php",
    "format": "json"
  },
